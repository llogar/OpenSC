...
static const struct ec_curve curves[] =
{
	...
	{
		/* brainpoolP384r1 */
		{ (unsigned char *) "\x06\x09\x2B\x24\x03\x03\x02\x08\x01\x01\x0B", 11},
	...
	{
		/* brainpoolP512r1 */
		{ (unsigned char *) "\x06\x09\x2B\x24\x03\x03\x02\x08\x01\x01\x0D", 11},
	...
	{
		/* secp521r1, nistp521 */
		{ (unsigned char *) "\x06\x05\x2B\x81\x04\x00\x23", 7},
